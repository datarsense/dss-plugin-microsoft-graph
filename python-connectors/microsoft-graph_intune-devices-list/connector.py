...
from helpers import raise_if_missing_plugin_parameters, listIntuneManagedDevices
from azure.identity import ClientSecretCredential


class ListIntuneManagedDevices(Connector):
    ...
    def generate_rows(self, dataset_schema=None, dataset_partitioning=None, partition_id=None, records_limit = -1):
        result = listIntuneManagedDevices(self.purview_credentials)
